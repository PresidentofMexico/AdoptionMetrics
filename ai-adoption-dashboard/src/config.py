...
# Data Configuration
DATA_DIR = "data"
HEADCOUNT_FILENAME = "Employee Headcount" # Partial name match
CHATGPT_EXPORT_PATTERN = ["*Openai*.csv", "*ChatGPT*.csv"]
BLUEFLAME_EXPORT_PATTERN = ["*blueflame*.csv", "*BlueFlame*.csv"]
